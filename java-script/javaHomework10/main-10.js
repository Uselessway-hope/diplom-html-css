...
console.log(`Меня зовут ${firstName} ${lastName}, мне ${age} год. Я ученик курса: ${isStudent}.`)
...
console.log('Я изначально думал, что выйдет строка , т.к. первая переменная это строка и происходит неявное преобразование типа и конкатенация строк как итог, ну вообщем так и вышло. Вот и получается : <123456789falsetrue>')
